...
\begin{figure}[hbt!]
        \begin{adjustwidth}{-0.5cm}{-0.5cm}%
                ...
                {
                        \includegraphics[width=0.5\textwidth]{Images/Chapter 3/DTW/DTW-Illustration-1.pdf}
                        \label{fig:DTW-Illustration-1}
                } \quad
                \subfloat[DTW distance between our 2 sequences.]
                {
                        \includegraphics[width=0.5\textwidth]{Images/Chapter 3/DTW/DTW-Illustration-2.pdf}
