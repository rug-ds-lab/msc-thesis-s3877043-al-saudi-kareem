...
In contrast to the earlier stages (or sections), stage 4 will be subdivided into Subsections \ref{subsec:Methodology:Stage-4:Classification-Tree} and \ref{subsec:Methodology:Stage-4:CNN-LSTM-Network} where Subsection \ref{subsec:Methodology:Stage-4:Classification-Tree} serves to present an overview of our classification model while Subsection \ref{subsec:Methodology:Stage-4:CNN-LSTM-Network} serves to present an overview of our forecasting model.
