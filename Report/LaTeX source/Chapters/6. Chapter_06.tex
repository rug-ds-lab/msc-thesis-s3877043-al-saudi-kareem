...
\begin{adjustwidth}{-1.65cm}{-0.0cm}%
    ...
    \begin{figure}[H]
        \begin{adjustwidth}{-3.0cm}{-3.0cm}%
                ...
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 6/Temporal_Illustration/Temporal_Illustration_1.pdf}
                        \label{fig:Temporal-Illustration-1}
                } \quad
                \subfloat[Visualizing our cyclical encoding of the time of day.]
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 6/Temporal_Illustration/Temporal_Illustration_2.pdf}
    ...
    \begin{figure}[hbt!]
        \begin{adjustwidth}{-3.0cm}{-3.0cm}%
                ...
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 6/UCID/UCID-Box-and-Whiskers-GAP-Out.pdf}
                        \label{fig:UCID-Box-and-Whiskers-GAP-Out}
                } \quad
                \subfloat[After removing outliers.]
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 6/UCID/UCID-Box-and-Whiskers-GAP-NoOut.pdf}
