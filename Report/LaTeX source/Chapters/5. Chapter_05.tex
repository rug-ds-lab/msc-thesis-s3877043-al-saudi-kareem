...
\begin{figure}[hbt!]
        \begin{adjustwidth}{-3.0cm}{-3.0cm}%
                ...
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 5/REFIT/REFIT-House-12-Day-of-the-Week-Count.pdf}
                ...
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 5/REFIT/REFIT-House-12-Month-Count.pdf}
...
\begin{figure}[hbt!]
        \begin{adjustwidth}{-3.0cm}{-3.0cm}%
                ...
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 5/REFIT/REFIT-House-12-Stack-Plot.pdf}
                ...
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 5/REFIT/REFIT-House-12-IAM-Plot.pdf}
...
\begin{figure}[hbt!]
        \begin{adjustwidth}{-3.0cm}{-3.0cm}%
                \myfloatalign
                \subfloat[Number of samples per day of the week over the entirety of the \gls{ucid} data set.]
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 5/UCID/UCID-Day-of-the-Week-Count.pdf}
                        \label{fig:UCID-House-12-Day-of-the-Week-Count}
                } \quad
                \subfloat[Number of samples per month over the entirety of the \gls{ucid} data set.]
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 5/UCID/UCID-Month-Count.pdf}
                        \label{fig:UCID-House-12-Month-Count}
                } \quad
                \caption{}
                \label{fig:UCID-Distribution}
        \end{adjustwidth}
\end{figure}
