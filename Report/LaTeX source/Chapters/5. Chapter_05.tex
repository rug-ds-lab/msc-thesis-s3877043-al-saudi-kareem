...
\begin{figure}[hbt!]
        \begin{adjustwidth*}{-3.0cm}{-3.0cm}%
                ...
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 5/UCID/UCID-Day-of-the-Week-Count.png}
                ...
                {
                        \includegraphics[width=0.7\textwidth]{Images/Chapter 5/UCID/UCID-Month-Count.png}
